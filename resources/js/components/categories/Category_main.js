...
const CategoryMain = (props) => {
 const gener = props.front[1];
 const front = props.front[0];
 ...
 return ( 
  ...
  <section className = "product-pad spad"> 
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <div class="product__page__content">
            ...
            <div class="row">
            {front && front.map( data => (
              
               <div class="col-lg-4 col-md-6 col-sm-6" key={data.id}>
               <div class="product__item">
               <Link to={`/anime-details/${data.id}`}>
                 <div class="product__item__pic set-bg" style={{backgroundImage : `url(../${data.image})`}} data-setbg="">
                 ...
                 <div class="product__item__text">
                   ...
                   <h5><a href={`/anime-details/${data.id}`}>{data.name}</a></h5>
                 </div>
                 </Link>
               </div>
             </div>
